                ...
                <form action="managerContact" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-4">
                            ...
                            <div id="reply-customer-msg" class="p-3 bg-glass rounded small text-info italic"></div>
                        </div>
            ...
            <div class="modal-content bg-dark text-white border-secondary">
                ...
                <div class="modal-body">
                    <div class="mb-4">
                        ...
                        <div id="view-customer-msg" class="p-3 bg-glass rounded small italic"></div>
                    </div>
                    <div>
                        <label class="text-success small mb-2"><i class="fa-solid fa-circle-check mr-1"></i> Shop phản hồi:</label>
                        <div id="view-owner-msg" class="p-3 bg-glass rounded border-left border-success" style="border-left-width: 4px !important;"></div>
                    </div>
                </div>
            </div>
        </div>
