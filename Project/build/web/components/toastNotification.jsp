...
<div id="toast-container" style="position: fixed; top: 100px; right: 20px; z-index: 9999; pointer-events: none;">
    ...
    <c:if test="${not empty errorMsg}">
        <div class="toast-item alert alert-danger shadow-lg animate__animated animate__fadeInRight" 
             style="min-width: 320px; border-radius: 12px; pointer-events: auto; display: flex; align-items: center; border-left: 5px solid #ef4444; background: rgba(15, 23, 42, 0.95); backdrop-filter: none !important; color: white; margin-bottom: 10px; padding: 15px 20px;">
    ...
    <c:if test="${not empty successMsg}">
        <div class="toast-item alert alert-success shadow-lg animate__animated animate__fadeInRight" 
             style="min-width: 320px; border-radius: 12px; pointer-events: auto; display: flex; align-items: center; border-left: 5px solid #22c55e; background: rgba(15, 23, 42, 0.95); backdrop-filter: none !important; color: white; margin-bottom: 10px; padding: 15px 20px;">
