    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <nav class="navbar navbar-expand-lg site-nav sticky-top">
            <div class="container">
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#mainNav" style="color: var(--text-main); border-color: var(--border);">
                ...
                <div class="collapse navbar-collapse" id="mainNav">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <c:if test="${sessionScope.acc != null and sessionScope.acc.role != 'customer'}">
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-warning" href="#" id="dashboardDropdown"
                        ...
                        <c:if test="${sessionScope.acc != null and sessionScope.acc.role == 'customer'}">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="purchaseHistory" title="Đơn mua của tôi">
                                    <i class="fas fa-shopping-bag mr-1"></i> Đơn mua
                                </a>
                            </li>
                        </c:if>
                    </ul>
                    ...
                    <form action="home" method="get" class="form-inline mr-lg-4">
                        <div class="position-relative">
                            <input class="form-control form-control-sm nav-search" type="search" name="keyword"
                                value="${key}" placeholder="Tìm kiếm giày...">
                            <i class="fas fa-search position-absolute text-muted"
                                style="right: 12px; top: 50%; transform: translateY(-50%); font-size: 0.8rem;"></i>
                        </div>
                    </form>

                    <div class="d-flex align-items-center mt-3 mt-lg-0 ml-lg-3">
                        <button type="button" id="theme-toggle" class="theme-toggle-btn mr-3" title="Đổi giao diện Sáng/Tối"
                            onclick="toggleTheme()">
                            <i class="fas fa-moon"></i>
                        </button>
                        <c:if test="${sessionScope.acc.role == 'customer'}">
                            <a href="wallet" class="btn btn-outline-warning btn-sm px-3 nav-btn-custom mr-3">
                        ...
                        <c:if test="${sessionScope.acc != null}">
                            ...
                            <a class="text-muted hover-white" href="logout" title="Đăng xuất">
                        ...
                        <c:if test="${sessionScope.acc == null}">
                            ...
                            <a class="btn btn-warning btn-sm px-4 nav-btn-custom" href="signup">Đăng ký</a>
                        </c:if>
                    </div>
                </div>
            </div>
