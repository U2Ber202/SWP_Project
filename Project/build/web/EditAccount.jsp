                ...
                <div class="edit-card">
                    <form action="EditAccount" method="post">
                        ...
                        <div class="edit-card-body">
                            ...
                            <%-- Chỉ hiển thị toggle Active/Inactive nếu KHÔNG phải admin --%>
                                    ...
                                    <div class="col-md-12 form-group mb-4">
                                        ...
                                        <div class="status-switch">
                                            <div class="status-switch-label">
                                                <strong id="statusText">${account.active ? 'Active' : 'Inactive'} Mode</strong>
                            ...
                            <%-- Nếu là admin thì giữ nguyên active = true, truyền ngầm qua hidden input --%>
                            <c:if test="${account.role == 'admin'}">
