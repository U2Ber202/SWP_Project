...
<html lang="vi">
    <head>
        ...
        <title>Quên Mật Khẩu | V-SNKR</title>
                    ...
                    <div class="col-md-8 col-lg-5">
                        <div class="card card-custom">
                            ...
                            <div class="text-center mb-4">
                                ...
                                <h3 class="fw-bold text-uppercase mt-3 mb-2 text-white">Quên Mật Khẩu?</h3>
                                <p class="small px-3" style="color: #94a3b8;">
                                    Đừng lo lắng! Vui lòng nhập địa chỉ email bạn đã đăng ký, chúng tôi sẽ gửi mã xác nhận để giúp bạn đặt lại mật khẩu.
                                </p>
                            </div>
                            ...
                            <form action="send-otp" method="POST">
                                <div class="mb-3 mt-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="email" class="form-control form-control-custom" required placeholder="Nhập địa chỉ email của bạn...">
                                    </div>
                                </div>
                            ...
                            <div class="mt-4 text-center border-top pt-4">
                                <a href="login" class="auth-link d-inline-flex align-items-center">
